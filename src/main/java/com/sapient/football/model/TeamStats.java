...
public class TeamStats {
    ...
    public int getOverall_league_GF() {
        return overall_league_GF;
    }

    public void setOverall_league_GF(int overall_league_GF) {
        this.overall_league_GF = overall_league_GF;
    }

    public int getOverall_league_GA() {
        return overall_league_GA;
    }

    public void setOverall_league_GA(int overall_league_GA) {
    ...
    public int getHome_league_GF() {
        return home_league_GF;
    }

    public void setHome_league_GF(int home_league_GF) {
        this.home_league_GF = home_league_GF;
    }

    public int getHome_league_GA() {
        return home_league_GA;
    }

    public void setHome_league_GA(int home_league_GA) {
    ...
    public int getAway_league_GF() {
        return away_league_GF;
    }

    public void setAway_league_GF(int away_league_GF) {
        this.away_league_GF = away_league_GF;
    }

    public int getAway_league_GA() {
        return away_league_GA;
    }

    public void setAway_league_GA(int away_league_GA) {
